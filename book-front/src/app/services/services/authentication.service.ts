...
export class AuthenticationService extends BaseService {
   ...
   */
  confirmAccount$Response(params: ConfirmAccount$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
   ...
   * This method doesn't expect any request body.
   */
  confirmAccount(params: ConfirmAccount$Params, context?: HttpContext): Observable<string> {
